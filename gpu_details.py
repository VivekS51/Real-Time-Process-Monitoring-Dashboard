...
#         if gpus:
#             gpu = gpus[0]
#             self.gpu_usage_data = self.gpu_usage_data[1:] + [gpu.load * 100]
#             self.gpu_mem_data = self.gpu_mem_data[1:] + [(gpu.memoryUsed / gpu.memoryTotal) * 100]

#             self.gpu_curve.setData(self.gpu_usage_data)
#             self.gpu_mem_curve.setData(self.gpu_mem_data)

#             details = (
#                 f"<b>Name:</b> {gpu.name}<br>"
#                 f"<b>Temperature:</b> {gpu.temperature}°C<br>"
#                 f"<b>Load:</b> {gpu.load * 100:.2f}%<br>"
#                 f"<b>Memory Used:</b> {gpu.memoryUsed} MB / {gpu.memoryTotal} MB<br>"
#                 f"<b>Driver:</b> {gpu.driver}"
#             )
#             self.details_label.setText(details)
#         else:
#             self.details_label.setText("No GPU detected.")
